...
use CeonInternet\AB\Console\Commands\AbMigrate;
use CeonInternet\AB\Console\Commands\AbReport;
use CeonInternet\AB\Console\Commands\AbRollback;
...
class LaravelAbServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->make('Illuminate\Contracts\Http\Kernel')->prependMiddleware('\CeonInternet\AB\Http\Middleware\LaravelAbMiddleware');
        $this->app->bind('Ab', 'CeonInternet\AB\SplitTest');
    ...
    {
        Blade::directive('split',function($expression){
            return "<?php Ceoninternet\AB\SplitTest::initiate{$expression}; ?>";
        });
        Blade::directive('endsplit',function($expression){

            return "<?php echo Ceoninternet\AB\SplitTest::tearDown{$expression}; ?>";
        });
